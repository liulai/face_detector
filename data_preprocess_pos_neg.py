...
def show_face_landmarks3(path, img, rect, rect2=None, kpt=None):
...
# generate postive and negative data(7:3)
...
def show_image(path, filename, id):
    ...
    print('img:', image)
    print('rect:', rect)
    show_face_landmarks3(path, image, rect, kpt=landmarks)
